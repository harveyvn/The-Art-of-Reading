...
The paper has defined many testing concepts transparently and illustrated the empirical evaluation carefully with proper research questions and statistical methods. However, due to the minor limitations above, I would love to give this paper 2 stars (1 - good /5 - bad).
