...
%
In addition, the approach encodes road networks as a hierarchical data structure and provides navigation paths, in which driving tasks can conduct and those paths are modeled as a graphic representation.
%
...
On the other hand, it might be possible that the measures used are not comparable across experiments which is considered as a construct validity threat. Thus, the authors might propose the solution on how to reduce this threat. 
%
In addition, the paper introduced DeepDriving extension which adjust the prediction quality of DeepDriving and if the predictions do not work as expected, the control will switch to BeamNG.AI which might cause a potential bias in the experiment.
%
...
The paper has defined many  concepts transparently and illustrated the empirical evaluation carefully with proper research questions and statistical methods. Even though, there are still small problems which can be solved in the future work, I would rate this paper 5 stars.
