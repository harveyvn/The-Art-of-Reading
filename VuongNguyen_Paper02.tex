...
\section{Summary}
%1/2 Page
The paper discusses the testing challenges of autonomous vehicles in the reality due to low performance and high danger which can cause fatal accidents. Despite computer intensive, virtual testing is considered as an alternative environment. Thus the authors propose a search-based procedural content generation approach to address these challenges. 
%
The paper introduced the procedural content generation (PCG) as an algorithm to create a game content and the search-based testing (SBST) as an algorithm to generate test cases in the self-driving car context and by combining two algorithms into a single approach, it will be able to produce efficient case studies for exposing problems of self-driving car software systems.
%
