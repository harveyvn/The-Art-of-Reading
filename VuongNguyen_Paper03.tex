...
\criticalquestion{What does it mean when authors argue using decision treen is better than SVM and other Machine Learning techniques due to its understandable boundaries? }% Optional answer follow
%{Those are some important notes about the question or a possible answer to it.}

\criticalquestion{The authors suggest a stopping criterion to control the number of vectors in each tree leaf not below a certain threshold. How does it prevent overfitting?}% Optional answer follow
% {Those are some important notes about the question or a possible answer to it.}
