...
%
Furthermore, the number of signals of the prototypical implementation is only two, the former is the upfront vehicle and the latter is the road characterists.
%
...
%
To conclude, I’m almost convinced that using the proposed approach to not only generate critical scenarios for stress-testing the self-driving car but also save the computational cost is by far an ideal, pragmatic approach for exposing many safety-critical problems of the self-driving cars and the proposed approach might be sufficient to translate this concept into applicable use.
